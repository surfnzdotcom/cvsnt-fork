...
bool CSocketIO::create(const char *address, const char *port, bool loopback /* = true */, bool tcp /* = true */)
{
...
#if defined( __HP_aCC )
	/*hint.ai_flags=hint.ai_flags|AI_NUMERICSERV;*/
	hint.ai_addrlen=0;
	...
	m_pAddrInfo=NULL;
/*
	Well yes, of course... that's the point.  Why trace it?
	if ((address==NULL)&&(hint.ai_flags&AI_PASSIVE))
		CServerIo::trace(3,"   The IP address portion of the socket address will be set to loopback address");
*/
