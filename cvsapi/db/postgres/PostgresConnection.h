...
#ifndef POSTGRESCONNECTION__H
#define POSTGRESCONNECTION__H
...
class CPostgresConnection : public CSqlConnection
{
public:
	CPostgresConnection();
	virtual ~CPostgresConnection();
